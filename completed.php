...
<div class=container>
<?php
$sql="SELECT * FROM completed ORDER BY b_id ASC";
...
<table>
  <tr>
   ...
   <td>
    <a href='completed.php?rn=<?php echo $row['b_id']; ?>'><button class="btn btn-primary">Delete</button></a></td>
   </td>
  </tr>
  </table>
...
<?php
$b_id=$_GET['rn'];
$query="DELETE FROM completed WHERE b_id='$b_id'";
