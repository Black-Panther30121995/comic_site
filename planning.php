...
<body>
  <div class="header">
  <h2 class="heading">PLANNING TO WATCH</h2>
</div>
<div class=container>
<?php
$sql="SELECT * FROM planning_to_watch ORDER BY b_id ASC";
...
<table>
  <tr>
   ...
   <td>
    <a href='planning.php?rn=<?php echo $row['b_id']; ?>'><button class="btn btn-primary">Delete</button></a></td>
   </td>
  </tr>
  </table>
...
<?php
$b_id=$_GET['rn'];
$query="DELETE FROM planning_to_watch WHERE b_id='$b_id'";
