...
<head>
    ...
    <title>WHEN JASY WJISTLESS</title>
     
</head>
<body>
    <div class="r"><img src="https://pbs.twimg.com/media/Ftj2xSIaQAEe6j8.jpg" class="image1">
      <img src="https://coffeemanga.io/wp-content/uploads/2023/02/coffee-2.jpeg" class="image1"><img src="https://i.pinimg.com/736x/59/cb/3e/59cb3ebe099bc7e882b3b2b50705fcbc.jpg" class="image1"></div>
    <div><br>
        <div class="container " style="background-color: rgb(247, 247, 247);">
            <div class="row form-control" style="background-color: rgb(159, 233, 233); font-size: 26px;">
                <div class="clr"><b>When Jasy Whistles</b></div>
                <div class="clr">
            ...
            <div class="row" style="padding-left: 100px;padding-right: 100px;">
                <div class="col-5">
                    <img src="https://images-na.ssl-images-amazon.com/images/S/compressed.photo.goodreads.com/books/1636576879i/58666592.jpg" width="285px"><br><br>
                ...
                <div class="col-7"><br><br>
                    ...
                    <div>
                        <p>
                        In ancient times, people believed that the jungles of Paraguay were filled with gods and monsters. Growing up outside of modern Asuncion, Hela never thought much of the old stories. When his best friend disappears, apparently kidnapped by the legendary Jasy Jatere, however, he learns that the old world is not as dead as he thought
                        </p>
                    </div>
                </div>
            </div><br><hr><br>
            <div class="row" style="padding-left: 230px;padding-right: 100px;">
                <div class="col-6">
                    ...
                    <h7><b>Synonyms:</b>When Jasy Says<br>
                ...
                <div class="col-6">
                    ...
                    <h7><b>Type:</b> <a href="https://r.search.yahoo.com/_ylt=AwrPrUN8e6VlR68fdGW7HAx.;_ylu=Y29sbwNzZzMEcG9zAzEEdnRpZAMEc2VjA3Ny/RV=2/RE=1705372668/RO=10/RU=https%3a%2f%2fen.wikipedia.org%2fwiki%2fManhwa/RK=2/RS=4sl7v1mOsMORm.64xaR.Mjzk8gg-" style="text-decoration: none;"> Manhwa</a><br>
                        <b>Volumes:</b> Ongoing<br>
                        <b>Chapters:</b> Ongoing<br>
                        <b>Status:</b> Publishing<br>
                        <b>Published:</b> Jan 6, 2020 to ?</h7><br>
                        <b>Genres:</b> 	Action - Adventure - Fantasy - Shoujo - Supernatural<br>
                        <b>Authors:</b> Cibeles<br>
                </div>
            </div><br><hr><br>
...
function setWatching($con){
  if(isset($_POST['Watching'])) {
   $book_name='When Jasy Whistles';
   $date=$_POST['date'];
   $book_img='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRaWsERm7U_yK2SrUy_DwqO-JgkYysC2W3bKw&usqp=CAU';
